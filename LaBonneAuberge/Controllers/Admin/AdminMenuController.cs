...
namespace LaBonneAuberge
{
    public class AdminMenuController : Controller
    {
        ...
        public AdminMenuController(LaBonneAubergeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,Img")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Img")] Menu menu)
        {
            if (id != menu.Id)
            {
                return NotFound();
